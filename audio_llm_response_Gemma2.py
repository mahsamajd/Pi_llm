...
output_directory = '/work/mahsam/IJCAI/audio_llm_gemma_results'
os.makedirs(output_directory, exist_ok=True)

# Paths to the Gemma models
gemma_models = {
    "gemma2": "/work/mahsam/IJCAI/llama.cpp/models/gemma2.gguf",
    "gemma2_Q8_0": "/work/mahsam/IJCAI/llama.cpp/models/gemma2_Q8_0.gguf",
    "gemma2_Q4_K_M": "/work/mahsam/IJCAI/llama.cpp/models/gemma2_Q4_K_M.gguf",
    "gemma2_Q2_K": "/work/mahsam/IJCAI/llama.cpp/models/gemma2_Q2_K.gguf"
}
...
def run_llm(model_path, transcription, max_tokens=50):
    """Runs the Gemma model using llama-cli with the provided transcription."""
...
Answer:"""
    ...
    print(f"Running LLM command: {' '.join(gemma_command)}")
    result = subprocess.run(gemma_command, capture_output=True, text=True)
